            ...
            {loading ? (
              ...
              <motion.div key="result" initial={{ opacity: 0 }} animate={{ opacity: 1 }} style={{ width: "100%", padding: "24px" }}>
                ...
                <motion.button
                  ...
                  style={{ width: "100%", marginTop: "16px", padding: "16px", background: "#0000FF", color: "#fff", border: "none", fontSize: "17px", cursor: "pointer", letterSpacing: "1px", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", boxShadow: "0 0 20px rgba(0,0,255,0.2)" }}
                >
                  {"📤 OPEN SHARE MODE ↗︎"}
                </motion.button>
              </motion.div>
